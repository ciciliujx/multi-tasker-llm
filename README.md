...
├── reward_reighted_sft.ipynb    # Extension using Reward-Weighted SFT
...
Additional experiment artifacts and archived training materials are provided in [`/doc`](/doc) or [docs-artifacts](https://github.com/ciciliujx/multi-tasker-llm/tree/docs-artifacts) branch, including command history and an archived exploratory training script used during development.
