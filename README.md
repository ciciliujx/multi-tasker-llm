...
Additional experiment artifacts and archived training materials are provided in [`/docs`](/docs) or [docs-artifacts](https://github.com/ciciliujx/multi-tasker-llm/tree/docs-artifacts) branch, including command history and an archived exploratory training script used during development.
